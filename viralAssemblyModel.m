...
eq1 = out_inf_pure + k_v*V*(D_max-D_gap-D_gmod) - alpha_c*D_gap - pure2modg;

% Covalently closed circular DNA in nucleus
eq2 = alpha_c*D_gap - gamma_c*D_ccc - pure2modc;

% Modified gapped DNA in nucleus
eq3 = out_inf_mod + k_v*V_m*(D_max-D_gap-D_gmod) - alpha_c*D_gmod + pure2modg; % Brandon to update

% Modified cccDNA in nucleus
eq4 = alpha_c*D_gmod - gamma_c*D_cmod + pure2modc; % Brandon to update
